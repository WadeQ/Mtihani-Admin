        ...
        mGoogleApiClient = new GoogleApiClient.Builder(getApplicationContext())
                .enableAutoManage(this,
                        connectionResult -> Toast.makeText(getApplicationContext(),
                                "You got an error", Toast.LENGTH_SHORT).show())
        ...
        mAuth.createUserWithEmailAndPassword(email, password).addOnCompleteListener(task -> {
            ...
            if (task.isSuccessful()) {
                ...
                reference.updateChildren (hashMap).addOnSuccessListener (aVoid -> {
                        ...
                        "Error saving data " + e.toString () , Toast.LENGTH_SHORT).show ());
                ...
                editor.putString(Constants.userName, etUsername.getText().toString().trim());
                ...
                Toast.makeText(
                        this,
                        "Something went wrong: " + task.getException(),
